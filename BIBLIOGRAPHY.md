...
**Deeper notes.** Own-words notes on what each source contributes, with formulas in the Sail's notation, are in [`docs/source-notes.md`](docs/source-notes.md) (a §0.1 derived record).
